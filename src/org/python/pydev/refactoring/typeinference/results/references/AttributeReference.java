...
public class AttributeReference implements IThing {
	...
	/* (non-Javadoc)
	 * @see org.python.pydev.refactoring.typeinference.results.references.IThing#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.python.pydev.refactoring.typeinference.results.references.IThing#getModule()
	 */
