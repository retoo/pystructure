...
\subsection{Picking a Root Goal}
...
\subsection{Selecting the Evaluator for a Goal}
...
The next example shows a different important problem: How are the types of arguments found. This time, the TI doesn't have to find the function, but the other way around: all callers of a function.\todo{rschuett: write me differently}
...
\subsubsection{Methods \& Attributes}
