...
Writing a structural analyser which is able to reveal a programs structure is just the first step of the job\todo{hmm besser}. Being able to get a good visualisation of the structure is at least as important. Instead of reinventing the wheel and creating a own visualiser PyStructure is meant as a supplier for the commercial structural analyser \textbf{\emph{Structure 101g}} developed by \textbf{\emph{Headway Software}}.

Structure 101g is able to visualise the structure of a program in a variety levels of details. It is able to do different kinds of anaylsis, like comparing the structure to a predefined architecture to detect any inconsistencies in the design or detect cyclic dependencies.
