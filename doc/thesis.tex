...
The lower part of the picture shows the components of PyStructure that are involved in this process. % was noch?
...
\begin{itemize}
    ...
    \item to Mathias Sulser and Mirko Stocker for corrections
\end{itemize}
