...
In the 16 weeks of the project we were able to accomplish most of the anticipated goals. The type inferencer used in PEPTIC\cite{peptic} was separated from Eclipse and moved to an independent new project. It now supports almost all of Python's language feature and is able to produce a sensible result in most cases. 

The implemented structural analyser is able to extract a programs internal structure, consisting of packages, modules and classes, and to identify all dependency-relevant expressions.
