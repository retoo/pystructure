...
Sometimes, it is useful to get an overview of the source code of a project, for example when one is new to a project or wants to refactor some parts. When directly looking at the source code, it is difficult to get a high-level perspective of the components and their dependencies. This is when a dedicated structure analysis program is useful.
