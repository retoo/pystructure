...
\todo{ich würde hier noch erwähnen dass diese analyse unabhängig ovn den eigentlichen typen ist. ALso z.b. wenn da ned var=42 sondern var = some_func() stehen würde könnte die benutzung von var trotzdem schon statisch an die definition gehängt werden, obwohl der typ ja nicht bekannt ist}
...
\begin{lstlisting}
if random():\todo{ich würd hier some_random_method nehmen, sonst versucht der leser noc hwas ins random() hineinzuinterpretieren. oder sometimestruesometimesnot ;)}
    x = 42
    print x
else:
    x = 3.14
