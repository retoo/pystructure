...
The structure is exported for further external analysis as an XML file. The content is separated into two parts, first a list of the components and second a list of dependencies between the components.
