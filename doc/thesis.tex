...
Flow analysis is an important part of type inference. In Python, it is possible that a variable is assigned multiple times with different types. This doesn't matter if the values are assigned sequentially and without conditional branches:
...
\subsection{Parts of Documentation from Previous Project}
