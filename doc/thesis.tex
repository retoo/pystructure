...
\subsection{Dependency break down}\todo{rstocker: geht der titel?}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1 \textwidth, trim=150 110 120 150, clip=true]{screen_method}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=1 \textwidth, trim=150 110 120 150, clip=true]{screen_method_selected}}
