...
\begin{lstlisting}
if random():\todo{ich wuerd hier some_random_method nehmen, sonst versucht der leser noc hwas ins random() hineinzuinterpretieren. oder sometimestruesometimesnot ;)}
    x = 42
    print x
else:
    x = 3.14
