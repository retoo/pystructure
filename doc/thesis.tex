...
In the 16 weeks of the project we were able to accomplish most of the planned goals. The type inferencer used in PEPTIC\cite{peptic} was separated from Eclipse and moved to an independent new project. It now supports almost all of Python's language feature and is able to produce a sensible result in most cases. 
...
As can been seen on the figure \vref{fig:screen_structure} the 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7 \textwidth, trim=0 0 0 0, clip=true]{screen_overview}
    \caption{Foo bars}
