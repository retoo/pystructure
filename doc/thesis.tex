...
Python modules are represented as \id{module} tags with their full path within the python project as the attribute name. All components beneath modules are stored using the \id{submodule} tag, with a attribute \id{type} specifying the actual type of component: \emph{class, function, method or attribute}
